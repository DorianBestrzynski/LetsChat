...
# print(res3
#       )
# res5 = messObj.post_send_sender_username_receiver_username_message_post("Adam", "Tomek", "teees " )
# print(res5)

# res = messObj.get_get_name_sender_get("Tomek", "Adam")
# print(res)
# res2 = messObj.get_new_get_new_name_sender_get("Tomek", "Adam")
# print(res2)
...
# print(res9)
# us = "Adam"
# res4 = usrObj.logout_logout_post({"login": "Dorian","password": "dorian"})
# print(res4)
# res7 = usrObj.active_users_active_users_get()
# dict1 = res7[0]
# for d in dict1:
#     print(d['login']['isActive'])
# dict2 = res7[1]
